...
(defun run-syllogism-diagnostics (&key (v nil))
  ...
  (let ((i 0)
    ...
    (dotimes (fig 4)
      ...
      (dolist (p1 major)
        (dolist (p2 minor)
          (when (not (diagnose-syllogism (list p1 p2) (nth i +syl-preds-v0.5+) :v v))
...
(defparameter *khemlani-&-johnson-laird-2014*
  `(((,x-is-A    ,Aab) "Is it necessary that..." (,x-is-B)    T 5.5 0.0 0.58 1.0 "1 - One model"      95  NIL T)
    ((,x-is-A    ,Aba) "Is it necessary that..." (,x-is-B)    T 5.5 0.0 0.58 1.0 "2 - Multiple model" 47  NIL T)
    ((,x-is-A    ,Eab) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "3 - One model"      93  NIL T)
    ((,x-is-A    ,Eba) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "4 - One model"      88  NIL T)
    ((,x-isnot-A ,Aab) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "5 - Multiple model" 50  NIL T)
    ((,x-isnot-A ,Aba) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "6 - One model"      90  NIL T)
    ((,x-isnot-A ,Eab) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "7 - Multiple model" 83  NIL T)
    ((,x-isnot-A ,Eba) "Is it necessary that..." (,x-isnot-B) T 5.5 0.0 0.58 1.0 "8 - Multiple model" 66  NIL T)))
...
(defparameter *temporal-inference-exp1&2-khemlani-et-al-in-prep*
  `(((,aBb  ,bBc ,dWa) "Is it necessary that..." (,dBb) T 5.5 0.5 0.0 1.0 "1 - One model"      75  NIL T)
    ((,aBb  ,cAb ,dWa) "Is it necessary that..." (,dBc) T 5.5 0.5 0.0 1.0 "2 - One model"      79  NIL T)
    ((,aAb2 ,bAc ,dWb) "Is it necessary that..." (,dAc) T 5.5 0.5 0.0 1.0 "3 - One model"      61  NIL T)
    ((,aAb2 ,bAc ,dWb) "Is it necessary that..." (,aAd) T 5.5 0.5 0.0 1.0 "4 - One model"      64  NIL T)
    ((,aBb  ,cBb ,dWa) "Is it necessary that..." (,dBc) T 5.5 0.5 0.0 1.0 "5 - Multiple model" 39  NIL T)
    ((,aBb  ,bAc ,dWa) "Is it necessary that..." (,dAc) T 5.5 0.5 0.0 1.0 "6 - Multiple model" 39  NIL T)
    ((,bAa  ,cBb ,aWd) "Is it necessary that..." (,cAd) T 5.5 0.5 0.0 1.0 "7 - Multiple model" 36  NIL T)
    ((,bAa  ,bAc ,aWd) "Is it necessary that..." (,cBd) T 5.5 0.5 0.0 1.0 "8 - Multiple model" 32  NIL T)))

(defparameter *temporal-inference-exp3-khemlani-et-al-in-prep*
  `(((,aBb  ,cWb          ) "Is it necessary that..." (,aBc2) T 4.5 0.5 0.4 1.0 "1  - One model"      00  NIL T)
    ((,aAb2 ,cAa          ) "Is it necessary that..." (,cAb)  T 4.5 0.5 0.4 1.0 "2  - One model"      00  NIL T)
    ((,aBb  ,aBc2         ) "Is it necessary that..." (,bBc)  T 4.5 0.5 0.4 1.0 "3  - Multiple model" 00  NIL T)
    ((,aAb2 ,cBa          ) "Is it necessary that..." (,cAb)  T 4.5 0.5 0.4 1.0 "4  - Multiple model" 00  NIL T)
    ((,aBb  ,bBc ,dWa     ) "Is it necessary that..." (,dBb)  T 4.5 0.5 0.4 1.0 "5  - One model"      00  NIL T)
    ((,aAb2 ,bAc ,dWb     ) "Is it necessary that..." (,dAc)  T 4.5 0.5 0.4 1.0 "6  - One model"      00  NIL T)
    ((,aBb  ,cBb ,dWa     ) "Is it necessary that..." (,dBc)  T 4.5 0.5 0.4 1.0 "7  - Multiple model" 00  NIL T)
    ((,bAa  ,cBb ,dWa     ) "Is it necessary that..." (,cAd)  T 4.5 0.5 0.4 1.0 "8  - Multiple model" 00  NIL T)
    ((,aBb  ,bBc ,dWa ,eWc) "Is it necessary that..." (,dBe)  T 4.5 0.5 0.4 1.0 "9  - One model"      00  NIL T)
    ((,aAb2 ,bAc ,dWb ,eWc) "Is it necessary that..." (,dAc)  T 4.5 0.5 0.4 1.0 "10 - One model"      00  NIL T)
    ((,aBb  ,cBb ,dWa ,eWc) "Is it necessary that..." (,dBe)  T 4.5 0.5 0.4 1.0 "11 - Multiple model" 00  NIL T)
    ((,bAa  ,cBb ,dWa ,eWc) "Is it necessary that..." (,dAc)  T 4.5 0.5 0.4 1.0 "12 - Multiple model" 00  NIL T)
))